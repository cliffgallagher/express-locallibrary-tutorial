...
function binarySearchAuthorObjects(arr, l, r, lastNameSearchingFor, firstNameSearchingFor){
    //console.log("arr is: " + arr);
    console.log("start index: " + l);
    console.log("end index: " + r);
    console.log("i am looking for: " + lastNameSearchingFor + ", " + firstNameSearchingFor);
    if (r >= l) {
        let mid = l + Math.floor((r - l) / 2);
        console.log("mid: " + mid);
        console.log("arr[mid]: " + JSON.stringify(arr[mid]));
        console.log("arr[mid][family_name]: " + arr[mid]["family_name"]);
        // If the element is present at the middle
        // itself
...
const authorArray = [{"first_name":"Ben","family_name":"Adams"}, {"first_name":"Zach","family_name":"Adams"}, {"first_name":"Ben","family_name":"Bova"}, {"first_name":"J","family_name":"Franzen"}, {"first_name":"Ed","family_name":"Richards"}]

console.log("author search result: " + binarySearchAuthorObjects(authorArray, 0, authorArray.length - 1, "Franzen", "J"));
