...
/* Create tables in local_library database in MySQL Workbench
async function syncAuthor() {
  await Author.sync();
  console.log("Author synced");
}
...
async function syncBookInstance() {
  try{
    await BookInstance.sync();
    console.log("BookInstance synced");
  } catch(e) {
    console.log(e);
  }
}
